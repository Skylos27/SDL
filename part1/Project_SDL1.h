...
constexpr int sheepVelocity = 1;
constexpr int wolfVelocity = 1;
...
class sheep : public animal {
  public:
    sheep(const std::string& file_path, SDL_Surface* window_surface_ptr, const int posX = 0, const int posY = 0);
    ~sheep();
...
class wolf : public animal {
  public:
    wolf(const std::string& file_path, SDL_Surface* window_surface_ptr, const int posX = 0, const int posY = 0);
    ~wolf();
